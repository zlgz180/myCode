package com.code.nio.basic.src.main.java.cn.enjoyedu.ch02.splicing.delimiter;
...
public class DelimiterClientHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ByteBuf msg = null;
        String request = "Mark,Lison,Peter,James,Deer" + DelimiterEchoServer.DELIMITER_SYMBOL;
        for (int i = 0; i < 10; i++) {
